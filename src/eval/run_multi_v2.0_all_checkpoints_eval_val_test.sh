...
python run_eval.py \
       --time_str $time_str \
       --tb_log_dir ../eval-tb-logs/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/$MODEL_TYPE/$time_str \
       --log_dir ../eval-logs/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/$MODEL_TYPE/$time_str \
       --output_dir ../eval-models/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/$MODEL_TYPE/$time_str \
       ...
       --all_checkpoints_dirpath /${mnt}/sanyuan.hy/workspace/LucaOne/models/lucagplm/v2.0/token_level,span_level,seq_level,structure_level/lucaone_gplm/20231125113045/ \
       --all_checkpoints_part "${part_idx}/${total_part}" \
       --eval_interval_step 200000 \
       --eval_min_step 0 \
       --eval_max_step 17600000