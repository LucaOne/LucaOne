...
cd ..
python run_eval_mask.py \
       --time_str $time_str \
       --tb_log_dir ../eval-mask-tb-logs/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/$MODEL_TYPE/$time_str \
       --log_dir ../eval-mask-logs/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/$MODEL_TYPE/$time_str \
       --output_dir ../eval-mask-models/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/$MODEL_TYPE/$time_str \
       ...
       --model_dirpath /${mnt}/sanyuan.hy/workspace/LucaOne/models/lucagplm/v2.0/token_level,span_level,seq_level,structure_level/lucaone_gplm/$model_time_str/checkpoint-step$model_checkpoint