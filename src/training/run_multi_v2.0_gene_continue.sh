...
trained_checkpoint=37600000
## training epoch
trained_epoch=1
## global_avg_loss = 0.7798372507095337 * 37600000
global_loss=29321880.626678467
## the training epoch_loss = 0.7798372507095337 * 37600000
epoch_loss=29321880.626678467
...
python -W ignore -m torch.distributed.launch --nnodes 1 --node_rank 0 --nproc_per_node=8 \
       ...
       --train_data_dir ../dataset/$DATASET_NAME/$DATASET_TYPE/gene2/train/ \
       --dev_data_dir ../dataset/$DATASET_NAME/$DATASET_TYPE/gene2/dev/ \
       --test_data_dir ../dataset/$DATASET_NAME/$DATASET_TYPE/gene2/test/ \
       ...
       --model_dirpath /mnt/sanyuan.hy/workspace/LucaOne/models/lucagplm/v2.0/token_level,span_level,seq_level,structure_level/lucaone_gplm/20231125124404/checkpoint-step$trained_checkpoint