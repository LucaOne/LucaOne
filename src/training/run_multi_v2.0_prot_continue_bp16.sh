#!/bin/bash
# for dataset
## the dataset only contain proteins
## the dataset name
...
PRETRAIN_TASK_LEVEL_NAME="prot_mask,prot_site,prot_homo,prot_domain,prot_taxonomy,prot_keyword,prot_structure"
...
# 实际tb-logs是 65280000
trained_checkpoint=65300000
## training epoch
trained_epoch=1
## global_avg_loss = 0.7798372507095337 * 37600000
global_loss=151298469.54345703
